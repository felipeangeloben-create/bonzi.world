            ...
            _createClass(Bonzi, [
                ...
                },
                {
                    ...
                    value: function (text, say, allowHtml, extra) {
                        ...
                        try {
                            (_this3.goingToSpeak = !0),
                                (_this3.$sapiProgress = _this3.$element.find(".sapi-loading-bar").length ? _this3.$element.find(".sapi-loading-bar") : (function(p){ p.css({position:"absolute",bottom:"100%",left:"50%",transform:"translateX(-50%)",width:"80px",display:"block",margin:"2px auto"}); _this3.$element.append(p); return p; })($("<progress class='sapi-loading-bar'></progress>"))),
                                _this3.$sapiProgress.show(),
                                (_this3.voiceSource = window.soundManager.createSound({
                                    id: String("talk_sound_" + (extra.audio.id || String(s4() + s4()))),
                                    url: extra.audio.url || "",
                                    autoLoad: !0,
                                    autoPlay: !0,
                                    onload: function () { _this3.$sapiProgress && _this3.$sapiProgress.hide(); },
                                    onfinish: function () {
                                        _this3.$sapiProgress && _this3.$sapiProgress.hide();
                                        setTimeout(function () {
                                            _this3.clearDialog(tkrb);
                                        }, 1e3);
                                    },
                                    onerror: function (code, description) {
                                        _this3.$sapiProgress && _this3.$sapiProgress.hide();
                                        console.log(this.id + " failed?", code, description), this.loaded ? (this.stop(), speakFallback()) : speakFallback();
                                    },
                                }));
                        } catch (err) {
