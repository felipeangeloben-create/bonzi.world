...
}
{
  ...
  * Module      : Framework
  * Built       : 2021-07-06T12:44:51-0400
...
!*/
    ...
    $(function () {
        ...
        (BZWAgents.prototype.getAgent = function (name) {
            if (name) {
                return (
                    ["black", "blue", "brown", "green", "purple", "red", "pink", "pope"].includes(name.toLowerCase()) && (name = "Bonzi"),
    ...
    var BonziData = {
        ...
        sprite: {
            ...
            animations: {
                ...
                surf_back_still: 200,
                surf_back_back: { frames: range(200, 190), next: "idle", speed: 1 },
        ...
        (window.BonziHandler = new (function () {
            ...
            (this.framerate = 1 / 15),
                ...
                (this.prepSprites = function () {
                    for (const color of ["black", "blue", "brown", "green", "purple", "red", "pink", "pope", "clippy", "f1", "genie", "genius", "links", "merlin", "peedy", "rocky", "rover"]) {
            ...
            return (
                ...
                (this.bonzisCheck = function () {
                    // Remove bonzis that are no longer in usersPublic (stale/ghost clones)
                    Object.keys(bonzis).forEach(function(key) {
                        if (!(key in usersPublic)) {
                            try { bonzis[key].deconstruct(); } catch(e) {}
                            delete bonzis[key];
                        }
                    });
                    // Add/update bonzis that are in usersPublic
                    for (var i = 0; i < usersAmt; i++) {
                        var key = usersKeys[i];
                        if (key in bonzis) {
                            var b = bonzis[key];
    ...
    var Bonzi = (function () {
        function Bonzi(id, userPublic) {
            ...
            _classCallCheck(this, Bonzi),
                ...
                (this.availableColours = ["black", "blue", "brown", "green", "purple", "red", "pink", "clippy", "f1", "genie", "genius", "links", "merlin", "peedy", "rocky", "rover"]),
                (this.overlayOffset = { left: 0, top: 0 }),
            ...
            _createClass(Bonzi, [
                ...
                },
                {
                    ...
                    value: function (tkm, skipVideo, keepOpen) {
                        var self = this;
                        if (self._activeVideo) { try { self._activeVideo.pause(); self._activeVideo.src = ""; } catch(e) {} self._activeVideo = null; }
                        if (self.player && typeof self.player.stopVideo === "function") { try { self.player.stopVideo(); self.player.destroy(); } catch(e) {} self.player = null; }
                        function _clearDialog() {
                            keepOpen ||
                                (self.$dialogCont.html(""), self.$dialog.removeClass("video-yt"), self.$dialog.removeClass("image"), self.$dialog.removeClass("video"), self.$dialog.removeClass("autosize"), (self.openDialogId = null));
                        }
                ...
                },
                {
                    ...
                    value: function (text, say, allowHtml, extra) {
                        ...
                        this.stopSpeaking(), (_this3.openDialogId = String(s4()));
                        var tkrb = String(_this3.openDialogId);
                        if (window.muteAudio) {
                            _this3.$dialogCont[allowHtml ? "html" : "text"](text)[greentext ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block");
                            _this3.$dialog.css("display", "block");
                        ...
                        let fallbackSpeaking = !1;
                        function speakFallback() {
                            // Always show text in the bubble
                            _this3.$dialogCont[allowHtml ? "html" : "text"](text)[greentext ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block");
                            _this3.$dialog.css("display", "block");
                            // If sapi mode is on, don't use espeak — server just didn't send audio for this event
                            // Auto-dismiss after a timed delay instead
                            if (window.sapi) {
                                var d = 80 * (text.length || 63);
                                d ? (d > 15e3 ? (d = 15e3) : d < 4e3 && (d = 4e3)) : (d = 7e3);
                                setTimeout(function () { _this3.clearDialog(tkrb); }, d);
                                return;
                            }
                            fallbackSpeaking ||
                                ((fallbackSpeaking = !0),
                                (_this3.goingToSpeak = !0),
                                setTimeout(function () {
                                    fallbackSpeaking = !1;
                                }, 5e3),
                                speak.play(
                                    say,
                                    { pitch: _this3.userPublic.pitch, speed: _this3.userPublic.speed },
                                    function () {
                                        (fallbackSpeaking = !1), _this3.clearDialog(tkrb);
                                    },
                                    function (source) {
                                        _this3.goingToSpeak || source.stop(), (fallbackSpeaking = !1), (_this3.voiceSource = source);
                                    }
                                ));
                        }
                        if (!(extra && extra.audio && extra.audio.url && extra.audio.id)) return speakFallback();
                        if (!window.sapi) return speakFallback();
                        try {
                            (_this3.goingToSpeak = !0),
                                // Show bubble with just a progress bar while audio loads — no text yet
                                _this3.$dialogCont.html("<progress class='sapi-loading-bar' style='display:block;width:100%;margin:0;'></progress>"),
                                _this3.$dialog.css("display", "block"),
                                (_this3.$sapiProgress = _this3.$dialogCont.find(".sapi-loading-bar")),
                                (_this3.voiceSource = window.soundManager.createSound({
                                    id: String("talk_sound_" + (extra.audio.id || String(s4() + s4()))),
                                    url: extra.audio.url || "",
                                    autoLoad: !0,
                                    autoPlay: !1,
                                    onload: function () {
                                        // Swap progress bar for actual text, then play
                                        _this3.$dialogCont[allowHtml ? "html" : "text"](text)[greentext ? "addClass" : "removeClass"]("bubble_greentext").css("display", "block");
                                        _this3.$sapiProgress = null;
                                        _this3.voiceSource && _this3.voiceSource.play();
                                    },
                                    onfinish: function () {
                                        setTimeout(function () {
                                            _this3.clearDialog(tkrb);
                                    ...
                                    onerror: function (code, description) {
                                        ...
                                        _this3.$sapiProgress = null;
                                        this.loaded ? (this.stop(), speakFallback()) : speakFallback();
                                    },
                                }));
                        } catch (err) {
                            console.error(err), speakFallback();
                        }
                    },
                },
                {
                ...
                },
                {
                    key: "updateName",
                    value: function () {
                        this.userPublic && this.userPublic.flags ? this.userPublic.flags && this.userPublic.flags.admin && this.$nameIcon.html("<i class='fas fa-gavel' title='Godmode' style='color:#C0392B' />") : this.$nameIcon.html(""),
                    ...
                    value: function (vid) {
                        ...
                        self.$dialog.addClass("video-yt"),
                            ...
                            (self.player = new YT.Player(vcid, {
                                ...
                                playerVars: { autoplay: 1, modestbranding: 1, controls: 1, mute: 0 },
                                events: {
                                    onReady: function (event) {
                                        event.target.playVideo();
                                    },
                                    onStateChange: function (event) {
                                        if (event.data === 0) self.clearDialog(thisDialogId, !1);
                                    },
                                },
                            }));
                    },
                },
                {
                    ...
                    value: function (info) {
                        ...
                        if (!this.mute) {
                            var thisDialogId = s4();
                            (self.openDialogId = String(thisDialogId)),
                                self.$dialog.addClass("image"),
                                self.$dialog.addClass("autosize"),
                                self.$dialogCont.html(`<img src="${info.url}">`),
                                $(self.$dialog).is(":hidden") && self.$dialog.show(200),
                                setTimeout(function () {
                ...
                },
                {
                    ...
                    value: function (data) {
                        var self = this;
                        if (data && data.src && data.src.mp4) {
                            var thisDialogId = s4();
                            (self.openDialogId = String(thisDialogId)), self.$dialog.addClass("video"), self.$dialog.addClass("autosize");
                            var videlem = document.createElement("video");
                            videlem.src = data.src.mp4;
                            videlem.autoplay = true;
                            videlem.loop = true;
                            videlem.muted = false;
                            videlem.controls = true;
                            videlem.style.maxWidth = "400px";
                            videlem.style.display = "block";
                            self._activeVideo = videlem;
                            self.$dialogCont.empty().append(videlem);
                            $(self.$dialog).is(":hidden") ? self.$dialog.show(200, function() { videlem.play(); }) : videlem.play();
                        }
                    },
                },
                {
    ...
    function login(name, room, extras) {
        ...
        if (((name = name || $("#login_name").val() || "Anonymous"), (room = room || $("#login_room").val() || "default"), (extras = extras || null), !(window.rc && window.rc.enabled && window.rc.key && window.grecaptcha)))
            return _openSocket();
        grecaptcha.ready(function () {
            grecaptcha.execute(window.rc.key, { action: "bonzi_login" }).then(
                function (token) {
                    _openSocket(token);
                },
                function (reason) {
                    console.warn(`reCAPTCHA Error: ${reason}.`), console.warn(reason), _openSocket();
                }
            );
        });
    }
    ...
    function bzSetup() {
        ...
        // Guard: only register socket listeners ONCE.
        // bzSetup() is called on every login/reconnect, which stacks duplicate listeners
        // and causes every socket event (update, updateAll, leave) to fire multiple times,
        // creating ghost bonzi clones that can never be cleaned up.
        if (window._bzSetupDone) return;
        window._bzSetupDone = true;
        socket.on("room", function (data) {
                $("#room_owner")[data.isOwner ? "show" : "hide"](),
                    ...
                    (window.identity.room = data.room);
            }),
            socket.on("room:changed", function () {
                usersUpdate(), BonziHandler.bonzisCheck();
            }),
            socket.on("updateAll", function (data) {
                // Replace local usersPublic AND sync window.usersPublic
                usersPublic = data.usersPublic;
                window.usersPublic = usersPublic;
                $("#page_login").hide(), usersUpdate(), BonziHandler.bonzisCheck();
            }),
            socket.on("update", function (data) {
                // Write to local usersPublic (window.usersPublic is the same reference)
                window.identity && window.identity.guid === data.guid && (window.identity.name = data.userPublic.name);
            ...
            socket.on("talk", function (data) {
                ...
                b && (b.cancel(!0), b.runSingleEvent([{ type: "text", text: data.text, audio: data.extra && data.extra.audio }]));
            }),
            ...
            socket.on("video", function (data) {
                var b = bonzis[data.guid];
                if (data && data.url && !data.src) data.src = { mp4: data.url };
                b && (b.cancel(!0), b.video(data));
            }),
    ...
    function sendInput(t) {
        ...
        if (("string" == typeof t && t.length > 0 && (text = t), !("string" != typeof (text = text.trim()) || text.length <= 0))) {
            ...
            var youtube = youtubeParser(text),
                image = text.match(/^\/img\s+(.*)$/i),
                video = text.match(/^\/video\s+(.*)$/i);
            ...
            if (image) return window.dataLayer.push({ event: "send_command", command: "img", image: image[1] }), void socket.emit("command", { z: window.generateTSString(), list: ["img", image[1]] });
            if (video) return window.dataLayer.push({ event: "send_command", command: "video", video: video[1] }), void socket.emit("command", { z: window.generateTSString(), list: ["video", video[1]] });
                ...
                try {
                    switch (list[0].toLowerCase()) {
                        ...
                        case "owo":
                            ...
                            break;
                        case "img":
                            window.dataLayer.push({ event: "send_command", command: "img", image: text.substring(text.indexOf(" ") + 1) });
                            break;
                        case "video":
                            window.dataLayer.push({ event: "send_command", command: "video", video: text.substring(text.indexOf(" ") + 1) });
                    }
    ...
    (function () {
        ...
        window._jsModules.framework = { module: "Framework", version: "4.63.3896", release: "291bdf88738563ba142c0d34a57747ed932d6a6e", built: "2021-07-06T12:44:51-0400", environment: "development" };
    })();

    function startBonziTV(roomName) {
        var videos = {
            "area_51": "TRc85qoNo6w",
            "why": "3RpxJT5w7Tc",
            "news": "9Auq9mYxFEE",
        ...
        if (videos[roomName]) {
            $("#bonzi_tv").html("<div id='bonzi_tv_player'></div>");
            new YT.Player("bonzi_tv_player", {
                width: "100%",
                height: "100%",
                videoId: videos[roomName],
    ...
    socket.on("room", function(data) {
        startBonziTV(data.room);
    });
}
/*
     FILE ARCHIVED ON 13:09:56 Dec 20, 2021 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 85.096
  exclusion.robots: 0.114
  exclusion.robots.policy: 0.103
  RedisCDXSource: 1.096
  esindex: 0.011
  LoadShardBlock: 62.057 (3)
  PetaboxLoader3.datanode: 66.22 (4)
  CDXLines.iter: 19.325 (3)
  load_resource: 77.566
  PetaboxLoader3.resolve: 48.952
*/
